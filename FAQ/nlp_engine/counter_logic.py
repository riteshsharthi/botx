...
class CounterLogic(object):
    ...
    def call_rest_api(self, data, url):
        ...
        if responce_data.status_code == 200:
            get_data =  responce_data.text

        else:
            get_data = "Sorry data not found for this id"
                    ...
                    if not_asked_question_flag or extracted_value_flag:
                        ...
                        if not_asked_question_flag:
                            ...
                            if context_data["chat_req"]["chat_attributes"]["asked_sequence_question"][seq]["count"] > 2:
                                ...
                                temp_response_text, context_data = self.get_intent_questions("failuretask", context_data)
    ...
    def task_completed(self, task_data, context_data, reply_text_list, type_of_action):
        ...
        if type_of_action == "completed":
            ...
            # print('Data hit --->',self.flatten_dict(data_to_hit), action_url)
            ...
            # context_data["chat_req"]["chat_type"] ="completed"
            # context_data["chat_req"]["message_id"] = deep_task
            # context_data["chat_req"]["time_zone"] = data_to_hit
    ...
    def main(self, user_uttarance, request):
        import pdb
        pdb.set_trace()
